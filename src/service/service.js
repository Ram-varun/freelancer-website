...
const getServiceDetails = (id) => {
    return axios.get(`${API}/api/v1/getServiceDetails/${id}`, authData)
}
...
export {
    API, signupService, signinService, getServiceDetails, getTodoListApi, addTodoListApi, updateTodoListApi, deleteTodoListApi, deleteAllTodoListApi
}